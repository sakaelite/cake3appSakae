...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'p_id' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'grade_id' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'color_id' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'created_emp_id' => ['type' => 'uuid', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'created_at' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'updated_emp_id' => ['type' => 'uuid', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            'id' => 'f8420b74-6766-47af-8626-b9abaf12a3b1',
            'p_id' => 'Lorem ipsum dolor sit amet',
            'name' => 'Lorem ipsum dolor sit amet',
            'basic_weight' => 1,
            'price' => 1,
            'customer_id' => 'Lorem ipsum dolor ',
            'grade_id' => 'Lorem ipsum dolor ',
            'color_id' => 'Lorem ipsum dolor ',
            'torisu' => 1,
            'cycle' => 1,
            'primary_p' => 1,
            'gaityu' => 1,
            'genjyou' => 1,
            'delete_flag' => 1,
            'created_emp_id' => '9aacc9d4-0494-4802-afee-5137780324e3',
            'created_at' => '2017-08-19 02:36:09',
            'updated_emp_id' => '14d5f5fe-d9d3-47f7-bff0-f1477ffe85f0',
            'updated_at' => '2017-08-19 02:36:09'
        ],
    ];
}
