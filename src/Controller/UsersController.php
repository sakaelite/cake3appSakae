...
class UsersController extends AppController
{
    ...
    public function add()
    {
        ...
        $arrEmployees = $this->Employees->find('all')->order(['emp_code' => 'ASC']);
        $arrEmp = array();
        foreach ($arrEmployees as $value) {
            $arrEmp[] = array($value->id=>$value->emp_code.":".$value->f_name."　".$value->l_name);
        }
        
        $this->set('user', $user);
        $this->set('arr',$arr);
        $this->set('arrNameAuthLevels',$arrNameAuthLevels);
        $this->set('arrEmp',$arrEmp);
        $this->set('arrEmployees',$arrEmployees);
